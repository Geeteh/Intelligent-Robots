...
class Detector:
	...
	def handle_image(self, msg):
		...
		for i in range(0, columns, 10):
			for j in range(260, 450):
				if image[j,i,0] > 47 and image[j,i,0] < 73 and image[j,i,1] > 147 and image[j,i,1] < 173 and image[j,i,2] > 177 and image[j,i,2] < 203:
					#image[j,i,0] = 0
					#image[j,i,1] = 0
					#image[j,i,2] = 0
					xcoord_sum += i
	...
	def handle_scan(self, msg):
		if not numpy.isnan(msg.ranges[-self.bearing]) and self.bearing != -1:
